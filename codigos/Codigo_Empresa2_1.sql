...
CREATE DATABASE EMPRESA2 collate utf8_spanish_ci;
...
PreAnu float (8,2) unsigned NOT NULL,
...
ALTER TABLE CENTRO
ADD CONSTRAINT CLAVEAJENA FOREIGN KEY (CodEmpDir) REFERENCES EMPLEADO (CodEmp) ON DELETE CASCADE;

ALTER TABLE DEPARTAMENTO
ADD CONSTRAINT CLAVEAJENA2 FOREIGN KEY (CodEmpDir) REFERENCES EMPLEADO (CodEmp) ON DELETE CASCADE;

CREATE TABLE HIJO 
(CodEmp int (6) unsigned,
index (CodEmp),
foreign key (CodEmp) REFERENCES EMPLEADO (CodEmp) ON DELETE CASCADE,
NumHij int (2) unsigned,
...
index(CodEmp),
foreign key (CodEmp) REFERENCES EMPLEADO (CodEmp) ON DELETE CASCADE,
NivHab int(2) unsigned DEFAULT 5 NOT NULL CHECK (NivHab BETWEEN 0 AND 10),
